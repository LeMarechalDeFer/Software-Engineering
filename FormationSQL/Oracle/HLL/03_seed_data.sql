...
-- VALUES ('Single', 100, 'available'),
--        ('Double', 150, 'available'),
--        ('Suite', 300, 'maintenance');

-- INSERT INTO clients (first_name, last_name, email, phone_number)
-- VALUES ('John', 'Doe', 'johndoe@example.com', '1234567890');

-- INSERT INTO translations (lang_code, translations)
-- VALUES ('en', '{"welcome": "Welcome", "room": "Room"}'),
--        ('fr', '{"welcome": "Bienvenue", "room": "Chambre"}');
...
INSERT INTO hotel_services_schedule ()
